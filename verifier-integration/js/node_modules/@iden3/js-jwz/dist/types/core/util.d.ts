...
export declare function bufToBn(u8: Uint8Array): bigint;
export declare function toBigEndian(bigNumber: bigint): Uint8Array;
export declare function ObjToArray(json: string): Uint8Array;
